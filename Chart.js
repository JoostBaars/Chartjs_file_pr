...
var Scale = function (_Element) {
  ...
  _proto._computeGridLineItems = function _computeGridLineItems(chartArea) {
    ...
    var _loop = function _loop() {
      ...
      createGridLine = function createGridLine(lineValue, overrideLineWidth) {
      ...
      createGridLine(lineValue);
      if (previousLineValue >= 0 && gridLines.linesBetweenNumbers > 0) {
        lineDistance = (lineValue - previousLineValue) / gridLines.linesBetweenNumbers;
        for (j = 1; j <= gridLines.linesBetweenNumbers; ++j) {
          createGridLine(previousLineValue + j * lineDistance, gridLines.n);
        }
      }
